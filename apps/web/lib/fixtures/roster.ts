...
export const demoRoster: Roster = {
  ...
  engineers: [
    { email: "ronit@zellify.app", role: "firefighter", slack: false, github: true },
    { email: "luka@zellify.app", role: "firefighter", slack: true, github: true },
    { email: "mikheil@zellify.app", role: "firefighter", slack: false, github: false },
    { email: "zurab@zellify.app", role: "firefighter", slack: true, github: true },
    { email: "marcus@zellify.app", role: "viewer", slack: false, github: false },
