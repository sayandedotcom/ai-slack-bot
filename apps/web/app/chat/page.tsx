      ...
      <div className="grid items-start gap-4 lg:grid-cols-12">
        <Card className="lg:col-span-7">
          <CardContent className="space-y-3">
            ...
            <p className="text-pretty border-t pt-3 text-muted-foreground text-xs">
              This opens a run — the same kind of run a Slack thread opens — and
              everything committal still needs a human. You land in the run and
              can steer it from there.
            </p>
          </CardContent>
        </Card>
