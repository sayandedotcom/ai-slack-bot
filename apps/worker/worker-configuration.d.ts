/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7c5e729cf7d09f8051e078876ef1dd4d)
...
interface __BaseEnv_Env {
	...
	ACCESS_APP_AUD: "UNSET_SEE_PHASE_11_NOTES";
	SLACK_SIGNING_SECRET: string;
	SLACK_BOT_TOKEN: string;
	ZEP_API_KEY: string;
	ANTHROPIC_API_KEY: string;
	BETTERSTACK_SQL_USERNAME: string;
	BETTERSTACK_SQL_PASSWORD: string;
	BETTERSTACK_UPTIME_TOKEN: string;
	LINEAR_API_KEY: string;
	LANGSMITH_API_KEY: string;
	SUPABASE_KEY: string;
	RUNS: DurableObjectNamespace<import("./src/index").RunDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RunDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTERSTACK_SQL_ENDPOINT" | "BETTERSTACK_LOG_SOURCE_IDS" | "LINEAR_TEAM_ID" | "LINEAR_TEAM_NAME" | "LANGSMITH_ENDPOINT" | "LANGSMITH_WORKSPACE_ID" | "LANGSMITH_PROJECT_ID" | "LANGSMITH_PROJECT_NAME" | "SUPABASE_URL" | "ARTIFACTS_BASE_URL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_APP_AUD" | "SLACK_SIGNING_SECRET" | "SLACK_BOT_TOKEN" | "ZEP_API_KEY" | "ANTHROPIC_API_KEY" | "BETTERSTACK_SQL_USERNAME" | "BETTERSTACK_SQL_PASSWORD" | "BETTERSTACK_UPTIME_TOKEN" | "LINEAR_API_KEY" | "LANGSMITH_API_KEY" | "SUPABASE_KEY">> {}
}
