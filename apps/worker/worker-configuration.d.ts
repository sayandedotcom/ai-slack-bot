/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: be447120d01e4898695f5a3655090073)
...
interface __BaseEnv_Env {
	...
	LOADER: WorkerLoader;
	ASSETS: Fetcher;
	BETTERSTACK_SQL_ENDPOINT: string;
	BETTERSTACK_LOG_SOURCE_IDS: string;
	...
	RUN_AGENTS: DurableObjectNamespace<import("./src/index").RunAgent>;
	SANDBOX: DurableObjectNamespace<import("./src/index").Sandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RunDO" | "Sandbox" | "RunAgent" | "CodemodeRuntime";
	}
